...
namespace DataConverter.Builders
{
    public class CustomerBuilder : IBuilder
    {
        ...
        public void BuildCustomers()
        {
            try
            {
                CustomersLoader custLoader = new CustomersLoader();
                List<CustomersDTO> customers = custLoader.LoadData(this.configuration.CustomersInputFile);
                ...
                var customersOutput = @"C:\temp\AndroidPixika\Result\Companies.json";
